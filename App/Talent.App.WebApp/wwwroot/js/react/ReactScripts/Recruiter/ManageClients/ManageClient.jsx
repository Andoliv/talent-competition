...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talentservicesprofileanderson.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talentservicesidentityanderson.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
